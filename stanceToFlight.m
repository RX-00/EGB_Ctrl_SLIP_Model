...
%   thus transitioning into the flight phase
    ...
    d = sqrt((q(1) - q(5))^2 + (q(3))^2);     % calculate the current length of the spring leg
    valFs = [s.k * (s.d0 - d), q(3)];         % if the spring force is 0 then you've left the ground, or body height is 0
